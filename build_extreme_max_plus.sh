...
# Let's start...
echo -e "Building Extreme Max Plus Kernel for Moto G5s Plus (sanders)...\n";
...
maindir=$HOME/Kernel/zip/extreme-max-plus;
outdir=$HOME/Kernel/out/extreme-max-plus/$device;
...
# Set the zip's name
zipname="ExtremeMaxPlus-$version-$device-AnyKernel";
